...
{
	std::vector<SFanProjection> vectors = genFanProjections(m_iProjectionAngleCount,
	                                            m_iDetectorCount,
	...
	return new CFanFlatVecProjectionGeometry2D(m_iProjectionAngleCount, m_iDetectorCount, std::move(vectors));
}
