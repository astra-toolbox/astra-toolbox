...
public:
	...
	*/
	 ...
	 */
	virtual bool isOfType(const std::string& _sType) const override { return _sType == "cone_vec"; }
...
private:
	...
	CConeVecProjectionGeometry3D(const CConeVecProjectionGeometry3D&)=default;
};
