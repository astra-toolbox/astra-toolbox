...
public:
	 ...
	 */
	CFloat32VolumeData2D(const CVolumeGeometry2D& _pGeometry);
	 ...
	 */
	CFloat32VolumeData2D(const CVolumeGeometry2D& _pGeometry, float32* _pfData);
	 ...
	 */
	CFloat32VolumeData2D(const CVolumeGeometry2D& _pGeometry, float32 _fScalar);
	 ...
	 *
	 */
	CFloat32VolumeData2D(const CVolumeGeometry2D& _pGeometry, CFloat32CustomMemory* _pCustomMemory);
	 ...
	 */
	bool initialize(const CVolumeGeometry2D& _pGeometry);
	 ...
	 * @param _pfData pointer to a one-dimensional float32 data block
	 */
	bool initialize(const CVolumeGeometry2D& _pGeometry, const float32* _pfData);
	 ...
	 * @param _fScalar scalar value to be put at each index.
	 */
	bool initialize(const CVolumeGeometry2D& _pGeometry, float32 _fScalar);
	 ...
	 *
	 */
	bool initialize(const CVolumeGeometry2D& _pGeometry, CFloat32CustomMemory* _pCustomMemory);
	 ...
	 */
	virtual const CVolumeGeometry2D& getGeometry() const;

	/** Change the projection geometry.
 	 *  Note that this can't change the dimensions of the data.
	 */
	virtual void changeGeometry(const CVolumeGeometry2D &pGeometry);
...
inline const CVolumeGeometry2D& CFloat32VolumeData2D::getGeometry() const
{
