...
int main (int argc, char *argv[])
{
    ...
    CCudaFilteredBackProjectionAlgorithm *algo;
    ifstream file;
    ...
    // algorithm
    algo = new CCudaFilteredBackProjectionAlgorithm();
    algo->initialize(sino,rec,FILTER_RAMLAK);
    algo->run();
    delete algo;

    // write sinogram data
    save_data_2d("sinogram_FBP.dat",sino);

    // write reconstruction data
    save_data_2d("reconstruction_FBP.dat",rec);
